            ...
            child: Column(
              children: [
                ...
                SingleChildScrollView(
                  ...
                  child: Row(
                    children: AppConst.dataKategoriKopi.map(
                          (dataIndex) {
                        var index = AppConst.dataKategoriKopi.indexOf(dataIndex);
                ...
                Expanded(
                  child: PageView.builder(
                    ...
                    itemCount: controller.listAllDataDummy.length,
                    onPageChanged: (int index) {
                      controller.currentPage = index;
                      controller.update();
                    },
                    itemBuilder: (context, index) {
                      var dataList = controller.listAllDataDummy[index];
